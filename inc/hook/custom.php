		...
		<div class="container">
			...
			<?php if( !empty( $footer_number ) ) : ?>
				...
				<dl class=" os-animation" data-os-animation="fadeInDown">
					...
					<dd><p><a href="tel:<?php echo preg_replace( '/\D+/', '', esc_attr( $footer_number ) ); ?>"><?php echo esc_attr($footer_number);?></a></p>						
					</dd>
				</dl>  
		...
		<div class="container">
			...
			<div class="footer-links">
				<div class="company-links">
					<a href="/wordpress/faqs" class="faqs">FAQs</a>
					<a href="/wordpress/shipping-returns" class="shipping-returns">Shipping & Returns</a>
					<a href="/wordpress/privacy" class="privacy">Privacy Policy</a>
					<a href="/wordpress/contact-us" class="contact-us">Contact Us</a>
				</div>
			</div>
